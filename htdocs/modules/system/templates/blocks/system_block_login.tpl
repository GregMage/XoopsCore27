<div class="txtcenter">
    <form style="margin-top: 0;" action="" method="post">
    ...
    <br>
    <a href="" title="<{$block.lang_lostpass}>"><{$block.lang_lostpass}></a>
    <br><br>
    <a href="" title="<{$block.lang_registernow}>"><{$block.lang_registernow}></a>
</div>
